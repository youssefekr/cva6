...
#(
  ...
  logic             [         CVA6Cfg.VLEN-1:0] pc_commit, npc_commit;
...
logic issue_valid_issue_if;
  ...
  frontend #(
      ...
      .npc_commit_i       (npc_commit),
      .is_commit_cf_i     (commit_instr_id_commit[0].fu == CTRL_FLOW),
      .commit_hartid_i    (commit_instr_id_commit[0].hartid),
      .is_commit_compressed_i (commit_instr_id_commit[0].is_compressed),
      .commit_valid_i     (commit_instr_id_commit[0].valid),
      .pc_issue_i            (issue_instr_id_acc.pc),
      .issue_hartid_i        (issue_instr_id_acc.hartid),
      .is_issue_compressed_i (issue_instr_id_acc.is_compressed),
      .issue_valid_i      (issue_valid_issue_if),
  ...
  issue_stage #(
      ...
      .issue_valid_o           (issue_valid_issue_if),
